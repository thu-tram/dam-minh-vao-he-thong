...
::: content
::: sect1
## [](#_some_advanced_c_features){.anchor}2.9. Some Advanced C Features {#_some_advanced_c_features}

::: sectionbody
::: paragraph
Almost all of the C programming language has been presented in previous
sections. In this section, we cover a few remaining advanced C language
features and some advanced C programming and compiling topics:
:::

::: ulist
-   [C constants, the `switch` statement, enumerated types, and
    typedef](advanced_switch.html#_c_switch_stmt_){.page}

-   [command line
    arguments](advanced_cmd_line_args.html#_c_cmd_line_args_){.page}

-   [the `void *` type and type
    re-casting](advanced_voidstar.html#_c_voidstar_recasting_){.page}

-   [pointer
    arithmetic](advanced_pointer_arithmetic.html#_c_ptr_arith_){.page}

-   [C libraries: using, compiling, and
    linking](advanced_libraries.html#_c_link_load_){.page}

-   [writing and using your own C
    libraries](advanced_writing_libraries.html#_c_libraries_){.page}
    (and dividing your program into multiple modules (`.c` and `.h`
    files))

-   [compiling C source to assembly
    code](advanced_assembly.html#_c_compiling_to_assemb_){.page}.
:::
:::
:::

...
::: content
::: sect1
## [](#_x64_assembly_chapter){.anchor}7. 64-bit x86 Assembly (x86-64) {#_x64_assembly_chapter}

::: sectionbody
::: paragraph
In this chapter, we cover the Intel Architecture 64-bit (x86-64)
instruction set architecture. Recall that an [instruction set
architecture](../C5-Arch/index.html#_what_von_neumann_knew_computer_architecture){.page}
...
to [Chapter 8](../C8-IA32/index.html#_IA32_assembly_chapter){.page}.
:::

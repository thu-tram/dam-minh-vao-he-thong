...
-   -   [13. The Operating System](index.html){.nav-link}
        -   [13.1. Booting and Running](impl.html){.nav-link}
        -   [13.2. Processes](processes.html){.nav-link}
        -   [13.3. Virtual Memory](vm.html){.nav-link}
        -   [13.4. Interprocess Communication](ipc.html){.nav-link}
            -   [13.4.1. Signals](ipc_signals.html){.nav-link}
            -   [13.4.2. Message Passing](ipc_msging.html){.nav-link}
            -   [13.4.3. Shared Memory](ipc_shm.html){.nav-link}
        -   [13.5. Summary and Other OS
            Functionality](advanced.html){.nav-link}
        -   [13.6. Exercises](exercises.html){.nav-link}

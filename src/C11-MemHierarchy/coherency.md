...
levels. Figure 1 shows an example of the
...
example in Figure 1, the L2 cache is a cache
...
5.9.2](../C5-Arch/modern.html#_multicore_and_hardware_multithreading)
...
Figure 2 through Figure 4 step through an
...
L1 caches. In Figure 2 our example starts with the shared
...
result of these actions, (shown in Figure 4), is that core
...
[Chapter
14.5](../C14-SharedMemory/cache_coherence.html#_cache_coherence_and_false_sharing),

...
Figure 1 depicts the stack immediately before the call to
`scanf`.
...
return code 139. Figure 3 shows what the call stack for
...
specifiers. Table 1 lists some common \"bad\" C functions

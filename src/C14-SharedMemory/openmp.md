...
:   This pragma creates a team of threads and has each thread run the
    ...
    Pthreads](posix.html#_creating_and_joining_threads). The
...
:   Specifies that each thread execute a subset of iterations of a `for`
    ...
    example](posix.html#_revisiting_scalar_multiplication). This
...
Pthreads](posix.html#_hello_threading_writing_your_first_multithreaded_program).
